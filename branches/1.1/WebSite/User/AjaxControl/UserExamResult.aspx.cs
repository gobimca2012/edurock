...
public partial class User_AjaxControl_UserExamResult : AjaxPage
{
    ...
    {
        ListUserExam.DataSource = new ExamController().GetExamsResultByLoginUserID(new UserAuthontication().LoggedInUserID);
