        ...
        <asp:ListView ID="ListQuestionType" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <%#_HtmlHelper.ListViewLinkButton("lnkd", "delete", Eval("QuestionTypeID").ToString(), "#QuestionType", "#QuestionType")%>
                    </td>
                    <td>
            ...
            <div style="float: right">
                <div style="float: left">
                    <aspajax:AjaxLinkButton ID="lnkPrevQuestionType" runat="server" Text="Prev" OnAjaxClick="PrevAjaxClick"
                        Pagger="true" Increment="false" RequestContainner="#QuestionType" ResponseContainner="#QuestionType"></aspajax:AjaxLinkButton>
                </div>
                <div style="float: left">
                    <aspajax:AjaxLinkButton ID="lnkNextQuestionType" runat="server" OnAjaxClick="NextAjaxClick"
                        RequestContainner="#QuestionType" Pagger="true" Increment="true" ResponseContainner="#QuestionType">Next</aspajax:AjaxLinkButton>
                </div>
            </div>
