...
public partial class Admin_Ajaxer_InstituteInfo : AjaxPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BindList();
            TotalPage = Convert.ToInt32(Math.Ceiling((decimal) new InstituteController().Get().Count / PageSize));
            PaggerLinkManager();
        }
    ...
    {
        ListInstitute.DataSource = new InstituteController().Get(PageSize, PageNumber);
    ...
    protected void ListInstituteOnItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        //string CourceCatagoryID = ListInstitute.DataKeys[currentItem.DataItemIndex]["CourceCatagoryID"].ToString();
