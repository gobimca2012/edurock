...
public partial class College_Ajaxer_InstituteUserInUserTypeInfo : AjaxPage
{
    ...
    protected void AddAjaxClick(object sender, AjaxControl.AjaxEventArg e)
    {
        ...
        Session[SessionName.SucessMessage.ToString()] = string.Format("{0}  has been Updated Successfully", "User Role ");
        BindData();
    }
    ...
    protected override void OnAjaxListViewCommand(AjaxListViewCommandArg e)
    {
        if (e.Command == "delete")
        {
            ...
            Session[SessionName.SucessMessage.ToString()] = string.Format("{0}  has been deleted Successfully", "User Role ");
            BindData();
        }
