...
<body>
    ...
    <div class="contentbox">
        ...
        <div class="gray">
            <asp:LinkButton ID="lnkedit" runat="server"><div class="btn editbtn"><%=Resources.Default.Edit_Text %></div></asp:LinkButton>
            <asp:LinkButton ID="lnkAddNew" runat="server"><div class="btn editbtn"><%=Resources.Default.Add_Text%></div></asp:LinkButton>
        </div>
    </div>
    </form>
</body>
