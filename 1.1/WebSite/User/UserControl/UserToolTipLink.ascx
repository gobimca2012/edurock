...
<div class="udate" style="width:100%">
    Creator : &nbsp;<asp:HyperLink ID="lnkTool" runat="server" CssClass="caps"></asp:HyperLink><br />
    Editor : &nbsp;<asp:HyperLink ID="lnkETool" runat="server" CssClass="caps"></asp:HyperLink><br />
