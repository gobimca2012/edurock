...
public partial class User_AjaxControl_BookMarkInfoView : AjaxPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        hpAddDocument.NavigateUrl = ResolveUrl("~/User/AjaxControl/BookMarkInfo.aspx") + "?dtype=" + _DocumentType.ToString();
        {
            BindList();
    ...
    {
        TotalPage = Convert.ToInt32(Math.Ceiling((decimal)new UserController().GetUserRelatedContentSearch(_LoginUserID, _InstituteCourceID, _InstituteSubjectID, (int)ContentTypeEnum.BookMark, new UserAuthontication().LoggedInUserID, Keywork, StartDate, EndDate).Count / PageSize));
        ListDocument.DataSource = new UserController().GetUserRelatedContentSearch(_LoginUserID, _InstituteCourceID, _InstituteSubjectID, (int)ContentTypeEnum.BookMark, new UserAuthontication().LoggedInUserID, Keywork, StartDate, EndDate, PageSize, PageNumber);
