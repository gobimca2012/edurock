...
namespace VT3.PayPal
{
    public class PayPalStandardPaymentProcessor
    {
        ...
        public PayPalStandardPaymentProcessor(string businessEmail)
        {
            useSandBox = true;// SettingManager.GetSettingValueBoolean("PaymentMethod.PaypalStandard.UseSandbox");
        ...
        {
            return ConfigurationSettings.AppSettings["PaypalURL"];//"https://www.sandbox.paypal.com/us/cgi-bin/webscr";
