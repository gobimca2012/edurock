...
namespace DataEntity
{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="EXM_Answer_EXM_UserAnswer", Storage="_EXM_UserAnswers", ThisKey="EXM_AnswerID", OtherKey="EXM_AnswerID")]
		...
		[Association(Name="EXM_Question_EXM_Answer", Storage="_EXM_Question", ThisKey="EXM_QuestionID", OtherKey="EXM_QuestionID", IsForeignKey=true)]
    ...
    partial void OnCreatedDateChanged();
		...
		[Association(Name="LoginUser_EXM_UserAnswer", Storage="_EXM_UserAnswers", ThisKey="LoginUserID", OtherKey="LoginUserID")]
		public EntitySet<EXM_UserAnswer> EXM_UserAnswers
		{
			get
			{
		...
		[Association(Name="LoginUser_UserExam", Storage="_UserExams", ThisKey="LoginUserID", OtherKey="LoginUserID")]
		...
		[Association(Name="LoginUser_Exam", Storage="_Exams", ThisKey="LoginUserID", OtherKey="LoginUserID")]
    ...
    partial void OnIsActiveChanged();
		...
		[Association(Name="EXM_Question_EXM_Answer", Storage="_EXM_Answers", ThisKey="EXM_QuestionID", OtherKey="EXM_QuestionID")]
		...
		[Association(Name="Exam_EXM_Question", Storage="_Exam", ThisKey="ExamID", OtherKey="ExamID", IsForeignKey=true)]
		public Exam Exam
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="EXM_Answer_EXM_UserAnswer", Storage="_EXM_Answer", ThisKey="EXM_AnswerID", OtherKey="EXM_AnswerID", IsForeignKey=true)]
		...
		[Association(Name="LoginUser_EXM_UserAnswer", Storage="_LoginUser", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="LoginUser_UserExam", Storage="_LoginUser", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
		public LoginUser LoginUser
		{
			get
			{
    ...
    partial void OnEndDateChanged();
		...
		[Association(Name="Exam_EXM_Question", Storage="_EXM_Questions", ThisKey="ExamID", OtherKey="ExamID")]
		...
		[Association(Name="LoginUser_Exam", Storage="_LoginUser", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
		public LoginUser LoginUser
		{
			get
			{
