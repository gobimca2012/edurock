...
namespace DataEntity
{
    ...
    partial void DeletePortalSetting(PortalSetting instance);
		...
		[Function(Name="dbo.GetInstituteByLoginUserID")]
		public ISingleResult<GetInstituteByLoginUserIDResult> GetInstituteByLoginUserID([Parameter(Name="LoginUserID", DbType="Int")] System.Nullable<int> loginUserID)
		{
		...
		[Function(Name="dbo.GetUserByInsituteCourceID")]
		public ISingleResult<GetUserByInsituteCourceIDResult> GetUserByInsituteCourceID([Parameter(Name="InsituteCourceID", DbType="Int")] System.Nullable<int> insituteCourceID)
		{
    ...
    partial void OnCreatedDateChanged();
		...
		[Association(Name="InstituteLoginUser_InstituteCourceUser", Storage="_InstituteCourceUsers", OtherKey="LoginUserID")]
    ...
    partial void OnModifieddateChanged();
		...
		[Association(Name="InstituteCource_InstituteCourceUser", Storage="_InstituteCourceUsers", OtherKey="InstituteCourceID")]
		public EntitySet<InstituteCourceUser> InstituteCourceUsers
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="InstituteUserType_InstituteUserTypeAccess", Storage="_InstituteUserTypeAccesses", OtherKey="InstituteUserTypeID")]
    ...
    partial void OnModifieddateChanged();
		...
		[Column(Storage="_InstituteUserInUserTypeID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
    ...
    partial void OnModifiedDateChanged();
		...
		[Column(Storage="_InstituteUserTypeAccessID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="InstituteUserType_InstituteUserTypeAccess", Storage="_InstituteUserType", ThisKey="InstituteUserTypeID", IsForeignKey=true)]
		public InstituteUserType InstituteUserType
		{
			get
			{
	...
	[Table(Name="dbo.InstituteCourceUser")]
    ...
    partial void OnModifieddateChanged();
		...
		[Column(Storage="_InstituteCourceUserID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_WhoLoginUserID", DbType="Int NOT NULL")]
		...
		[Association(Name="InstituteCource_InstituteCourceUser", Storage="_InstituteCource", ThisKey="InstituteCourceID", IsForeignKey=true)]
		public InstituteCource InstituteCource
		{
			get
			{
		...
		[Association(Name="InstituteLoginUser_InstituteCourceUser", Storage="_InstituteLoginUser", ThisKey="LoginUserID", IsForeignKey=true)]
		public InstituteLoginUser InstituteLoginUser
		{
			get
			{
    ...
    partial void OnIsDeletedChanged();
		...
		[Column(Storage="_Logo", DbType="VarChar(MAX)")]
		public string Logo
		{
			get
			{
		...
		[Association(Name="Institute_PortalSetting", Storage="_PortalSettings", OtherKey="InstituteID")]
    ...
    partial void OnModifiedDateChanged();
		...
		[Column(Storage="_PortalSettingID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_Settings", DbType="Xml NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="Institute_PortalSetting", Storage="_Institute", ThisKey="InstituteID", IsForeignKey=true)]
		public Institute Institute
		{
			get
			{
	...
	public partial class GetInstituteByLoginUserIDResult
	{
		...
		[Column(Storage="_InstituteName", DbType="VarChar(MAX) NOT NULL", CanBeNull=false)]
