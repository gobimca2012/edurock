...
namespace DataEntity
{
    ...
    partial void DeleteShare(Share instance);
		...
		[Function(Name="dbo.GetInstituteCourseByLoginUserEditAccess")]
		public ISingleResult<GetInstituteCourseByLoginUserEditAccessResult> GetInstituteCourseByLoginUserEditAccess([Parameter(Name="LoginUserID", DbType="Int")] System.Nullable<int> loginUserID, [Parameter(Name="InstituteID", DbType="Int")] System.Nullable<int> instituteID)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), loginUserID, instituteID);
			return ((ISingleResult<GetInstituteCourseByLoginUserEditAccessResult>)(result.ReturnValue));
		}
		
		[Function(Name="dbo.GetItemEditAccessByLoginUserID", IsComposable=true)]
		public System.Nullable<bool> GetItemEditAccessByLoginUserID([Parameter(Name="ObjectID", DbType="VarChar(100)")] string objectID, [Parameter(Name="ObjectType", DbType="Int")] System.Nullable<int> objectType, [Parameter(Name="LoginUserID", DbType="Int")] System.Nullable<int> loginUserID)
		{
		...
		public ISingleResult<GetShareUserResult> GetShareUser([Parameter(Name="ObjectType", DbType="Int")] System.Nullable<int> objectType, [Parameter(Name="ObjectID", DbType="VarChar(100)")] string objectID, [Parameter(Name="InstituteID", DbType="Int")] System.Nullable<int> instituteID)
		{
		...
		public ISingleResult<GetShareGroupResult> GetShareGroup([Parameter(Name="ObjectType", DbType="Int")] System.Nullable<int> objectType, [Parameter(Name="ObjectID", DbType="VarChar(100)")] string objectID, [Parameter(Name="InstituteID", DbType="Int")] System.Nullable<int> instituteID)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), objectType, objectID, instituteID);
    ...
    partial void OnCreatedDateChanged();
		...
		[Association(Name="StudentLogin_UserEducation", Storage="_UserEducations", ThisKey="LoginUserID", OtherKey="LoginUserID")]
		...
		[Association(Name="StudentLogin_ShareUser", Storage="_ShareUsers", ThisKey="LoginUserID", OtherKey="LoginUserID")]
		...
		[Association(Name="StudentLogin_User", Storage="_Users", ThisKey="LoginUserID", OtherKey="LoginUserID")]
		...
		[Association(Name="StudentLogin_Comment", Storage="_Comments", ThisKey="LoginUserID", OtherKey="LoginUserID")]
		...
		[Association(Name="StudentLogin_Document", Storage="_Documents", ThisKey="LoginUserID", OtherKey="LoginUserID")]
		...
		[Association(Name="StudentLogin_Article", Storage="_Articles", ThisKey="LoginUserID", OtherKey="LoginUserID")]
		...
		[Association(Name="StudentLogin_Event", Storage="_Events", ThisKey="LoginUserID", OtherKey="LoginUserID")]
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="StudentLogin_UserEducation", Storage="_StudentLogin", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="Document_DocumentCource", Storage="_Document", ThisKey="DocumentID", OtherKey="DocumentID", IsForeignKey=true)]
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="Share_ShareGroup", Storage="_Share", ThisKey="ShareID", OtherKey="ShareID", IsForeignKey=true)]
		public Share Share
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="StudentLogin_ShareUser", Storage="_StudentLogin", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
		public StudentLogin StudentLogin
		{
			get
			{
		...
		[Association(Name="Share_ShareUser", Storage="_Share", ThisKey="ShareID", OtherKey="ShareID", IsForeignKey=true)]
		public Share Share
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="StudentLogin_User", Storage="_StudentLogin", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
		public StudentLogin StudentLogin
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="StudentLogin_Comment", Storage="_StudentLogin", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
		public StudentLogin StudentLogin
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="Document_DocumentCource", Storage="_DocumentCources", ThisKey="DocumentID", OtherKey="DocumentID")]
		...
		[Association(Name="StudentLogin_Document", Storage="_StudentLogin", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
		public StudentLogin StudentLogin
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="StudentLogin_Article", Storage="_StudentLogin", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
		public StudentLogin StudentLogin
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="StudentLogin_Event", Storage="_StudentLogin", ThisKey="LoginUserID", OtherKey="LoginUserID", IsForeignKey=true)]
		public StudentLogin StudentLogin
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Column(Storage="_EnableAllUserAdd", DbType="Bit")]
		...
		[Association(Name="Share_ShareGroup", Storage="_ShareGroups", ThisKey="ShareID", OtherKey="ShareID")]
		...
		[Association(Name="Share_ShareUser", Storage="_ShareUsers", ThisKey="ShareID", OtherKey="ShareID")]
		public EntitySet<ShareUser> ShareUsers
		{
			get
			{
