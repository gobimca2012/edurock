...
namespace BusinessLogic
{
    public class InstituteUserController
    {
        ...
        public List<InstituteUser> GetbyInstituteUserTypeID(int InstituteUserTypeID, int PageSize, int PageNumber)
        {
            try
            {
                return new DataProvider().InstituteUserGetbyInstituteUserTypeID(InstituteUserTypeID, PageSize, PageNumber);
            }
            catch (Exception ex)
            {
                if (SettingProvider.IsLoggerEnable())
        ...
        public List<InstituteUser> GetbyInstituteUserTypeID(int InstituteUserTypeID)
        {
            try
            {
                return new DataProvider().InstituteUserGetbyInstituteUserTypeID(InstituteUserTypeID);
            }
            catch (Exception ex)
            {
                if (SettingProvider.IsLoggerEnable())
        ...
        public bool Add(int InstituteUserID, int InstituteID, int LoginUserID, int InstituteUserTypeID, string Description, DateTime ModifiedDate)
        {

            try
            {
                new DataProvider().InstituteUserAdd(InstituteUserID, InstituteID, LoginUserID, InstituteUserTypeID, Description, ModifiedDate);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public int Add(int InstituteID, int LoginUserID, int InstituteUserTypeID, string Description, DateTime ModifiedDate)
        {

            try
            {
                int ID = new DataProvider().InstituteUserAdd(InstituteID, LoginUserID, InstituteUserTypeID, Description, ModifiedDate);
                return ID;
            }
            catch (Exception ex)
            {
        ...
        public bool DeletebyInstituteUserTypeID(int InstituteUserTypeID)
        {
            try
            {
                new DataProvider().InstituteUserDeletebyInstituteUserTypeID(InstituteUserTypeID);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool UpdateByInstituteUserID(int InstituteUserID, int InstituteID, int LoginUserID, int InstituteUserTypeID, string Description, DateTime ModifiedDate)
        {

            try
            {
                new DataProvider().InstituteUserUpdateByInstituteUserID(InstituteUserID, InstituteID, LoginUserID, InstituteUserTypeID, Description, ModifiedDate);
                return true;
            }
            catch (Exception ex)
            {
