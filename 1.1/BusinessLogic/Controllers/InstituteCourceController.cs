    ...
    public class InstituteCourceController
    {
        ...
        public List<GetInstituteCourseByLoginUserViewAccessResult> GetInstituteCourseByLoginUserViewAccess(int LoginUserID, int InstituteID)
        {
            try
            {
                ...
                return new DataProvider().GetInstituteCourseByLoginUserViewAccess(LoginUserID, InstituteID);
            }
            catch
            {
                return new List<GetInstituteCourseByLoginUserViewAccessResult>();
            }
        }
        public List<GetInstituteCourseByLoginUserViewAccessResult> GetInstituteCourseByLoginUserViewAccess(int LoginUserID, int InstituteID, int PageSize, int PageNumber)
        {
            try
            {
                ...
                return new DataProvider().GetInstituteCourseByLoginUserViewAccess(LoginUserID, InstituteID, PageSize, PageNumber);
            }
            catch
            {
                return new List<GetInstituteCourseByLoginUserViewAccessResult>();
        ...
        public List<GetInstituteCourseByLoginUserEditAccessResult> GetInstituteCourseByLoginUserEditAccess(int LoginUserID, int InstituteID)
        {
            try
            {
                ...
                return new DataProvider().GetInstituteCourseByLoginUserEditAccess(LoginUserID, InstituteID);
            }
            catch
            {
                return new List<GetInstituteCourseByLoginUserEditAccessResult>();
            }
        }
        public List<GetInstituteCourseByLoginUserEditAccessResult> GetInstituteCourseByLoginUserEditAccess(int LoginUserID, int InstituteID, int PageSize, int PageNumber)
        {
            try
            {
                ...
                return new DataProvider().GetInstituteCourseByLoginUserEditAccess(LoginUserID, InstituteID, PageSize, PageNumber);
            }
            catch
            {
                return new List<GetInstituteCourseByLoginUserEditAccessResult>();
        ...
        public List<GetInstituteCourseByLoginUserAddAccessResult> GetInstituteCourseByLoginUserAddAccess(int LoginUserID, int InstituteID)
        {
            try
            {
                ...
                return new DataProvider().GetInstituteCourseByLoginUserAddAccess(LoginUserID, InstituteID);
            }
            catch
            {
                return new List<GetInstituteCourseByLoginUserAddAccessResult>();
            }
        }
        public List<GetInstituteCourseByLoginUserAddAccessResult> GetInstituteCourseByLoginUserAddAccess(int LoginUserID, int InstituteID, int PageSize, int PageNumber)
        {
            try
            {
                ...
                return new DataProvider().GetInstituteCourseByLoginUserAddAccess(LoginUserID, InstituteID, PageSize, PageNumber);
            }
            catch
            {
                return new List<GetInstituteCourseByLoginUserAddAccessResult>();
        ...
        public void DeleteInstituteCourseByInstituteCourseID(int InstituteCourseID)
        {
            try
            {
                 ...
                 new DataProvider().DeleteInstituteCourseByInstituteCourseID(InstituteCourseID);
            }
            catch
            {
        ...
        public void DeleteInstituteCourseByInstituteCourseID(int InstituteCourseID, int PageSize, int PageNumber)
        {
            try
            {
                 ...
                 new DataProvider().DeleteInstituteCourseByInstituteCourseID(InstituteCourseID, PageSize, PageNumber);
            }
            catch
            {
        ...
        {
            var data = GetInstituteCourseByLoginUserAddAccess(new UserAuthontication().LoggedInUserID,new UserAuthontication().InstituteID);
            dd.DataSource = data;
            dd.DataTextField = "CourceName";
            dd.DataValueField = "InstituteCourceID";
            dd.DataBind();
