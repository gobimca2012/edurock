        ...
        public void StoreContentHistory(string ContentID, int ContentType)
        {
            if (ContentType == (int)ContentTypeEnum.Image || ContentType == (int)ContentTypeEnum.Video || ContentType == (int)ContentTypeEnum.Document || ContentType == (int)ContentTypeEnum.Audio)
            {
                ...
                if (HistoryData.Count > 0)
                {
                    ...
                    string XmlResultString = new XMLHelper().SerializeXML(Adata);
                    HistoriesXml.AddFirst(new XMLHelper().GetXElementFromString(XmlResultString,"Document"));
                ...
                else
                {
                    ...
                    LData.Add(Adata);
                    string Xml=new XMLHelper().SerializeXML(LData);
                    
                    HistoriesXml=new XMLHelper().GetXElementFromString(Xml, "ArrayOfDocument");                    
                }
