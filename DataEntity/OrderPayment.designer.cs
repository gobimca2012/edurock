...
namespace DataEntity
{
    ...
    partial void OnModifiedDateChanged();
		...
		[Column(Storage="_OrderItemID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_ItemName", DbType="VarChar(MAX) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ItemDescription", DbType="VarChar(MAX)")]
    ...
    partial void OnModifiedDateChanged();
		...
		[Column(Storage="_PaymentID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_PaymentCurrency", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_PaymentType", DbType="Int NOT NULL")]
		...
		[Association(Name="Order_Payment", Storage="_Order", ThisKey="OrderID", IsForeignKey=true)]
		public Order Order
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Column(Storage="_FirstName", DbType="VarChar(1000) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_LastName", DbType="VarChar(1000) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_PhoneNumber", DbType="VarChar(15) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Email", DbType="VarChar(2000) NOT NULL", CanBeNull=false)]
		public string Email
		{
			get
			{
		...
		[Column(Storage="_Address1", DbType="VarChar(MAX) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_City", DbType="VarChar(1000) NOT NULL", CanBeNull=false)]
		public string City
		{
			get
			{
		...
		[Column(Storage="_State", DbType="VarChar(1000) NOT NULL", CanBeNull=false)]
		public string State
		{
			get
			{
		...
		[Column(Storage="_Country", DbType="VarChar(1000) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ZipCode", DbType="VarChar(12) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Order_Payment", Storage="_Payments", OtherKey="OrderID")]
