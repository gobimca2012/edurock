...
namespace JScripter
{
    ...
    {
        public AjaxValidation(Page thisPage,LinkButton lnkSubmitButton)
        {
            JScripter.IncludeJavascriptFile("Validation", thisPage.ResolveUrl("~/MusesterScript/AjaxFormValidation.js"), thisPage);
            //string Script = string.Format("$('#{0}').ValidateButton();", lnkSubmitButton.ClientID);
            //InjectScript(Script, thisPage);
        }
        public AjaxValidation(Page thisPage, LinkButton lnkSubmitButton,bool IsloadScript)
        {
            if (IsloadScript)
            {
                JScripter.IncludeJavascriptFile("Validation", thisPage.ResolveUrl("~/MusesterScript/AjaxFormValidation.js"), thisPage);
        ...
        public AjaxValidation(Page thisPage, Button btnSubmitButton)
        {
            JScripter.IncludeJavascriptFile("Validation", thisPage.ResolveUrl("~/MusesterScript/AjaxFormValidation.js"), thisPage);
